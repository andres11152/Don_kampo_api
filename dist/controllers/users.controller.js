...
export const createUsers = async (req, res) => {
  ...
  try {
    ...
    const client = await getConnection();
    console.log("Query: ", queries.users.createUsers, [user_name, first_name, last_name, email, phone, department, city, address, neighborhood, locality, user_status, hashedPassword]);
